...
const TargetToday = () => {
  ...
  return (
    <section className="pt-0 pb-3 bg-gray-50" id="target-today">
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="text-2xl md:text-[28px] font-bold text-center text-slate-900 mb-6">What is your Target Today ?</h2>
