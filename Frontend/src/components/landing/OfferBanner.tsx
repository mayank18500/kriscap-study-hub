...
const OfferBanner = ({ onViewStore }: OfferBannerProps) => {
  ...
  const handleBannerClick = (action: string) => {
    if (action === "store") {
      window.open("https://wa.me/917023057797");
      // onViewStore();
      // window.scrollTo({ top: 0, behavior: "smooth" });
    } else if (action === "youtube") {
      window.open("https://youtube.com/@kriscapeducation?si=NlN3mUMGulpVxYPg", "_blank");
    } else if (action === "admission") {
      window.location.href = "https://wa.me/917023057797?text=Hello%20Kriscap%20Team,%20I%20am%20interested%20in%20admissions.%20Please%20provide%20me%20with%20the%20details.";
    }
  };
