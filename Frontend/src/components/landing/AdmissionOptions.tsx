    ...
    <section className="py-12 bg-gray-50 pb-24 border-b border-slate-100" id="admission-options">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 max-w-4xl mx-auto">
          {/* Public Option */}
          <Link to="/admission" className="flex-1 flex items-center justify-center gap-3 bg-primary text-white py-4 px-6 rounded-2xl shadow-lg shadow-primary/20 hover:bg-primary/90 hover:shadow-xl hover:-translate-y-1 transition-all">
