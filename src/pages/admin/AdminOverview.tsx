...
import { TrendingUp, TrendingDown, DollarSign, ShoppingBag, Users, Package, ArrowUpRight } from "lucide-react";
...
const AdminOverview = () => {
  ...
  const recentOrders = [
    { id: "ORD-2024-156", customer: "Rahul S.", type: "TMA", amount: 199, status: "Completed" },
    { id: "ORD-2024-155", customer: "Priya K.", type: "Project", amount: 499, status: "Processing" },
    { id: "ORD-2024-154", customer: "Amit P.", type: "TMA", amount: 149, status: "Completed" },
    { id: "ORD-2024-153", customer: "Neha R.", type: "Project", amount: 399, status: "In Transit" },
    { id: "ORD-2024-152", customer: "Vikram J.", type: "TMA", amount: 199, status: "Completed" },
  ];
